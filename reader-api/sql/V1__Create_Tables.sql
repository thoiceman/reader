...
CREATE INDEX idx_library_id ON book (library_id);
...
(
    ...
    review_count          INT,
    cover                 VARCHAR(255),
    cover_updated_on      TIMESTAMPTZ NULL,
...
CREATE INDEX idx_book_metadata_id ON book_metadata_author_mapping (book_id);
CREATE INDEX idx_author_id ON book_metadata_author_mapping (author_id);
...
(
    ...
    user_id        BIGINT        NOT NULL,
    book_id        BIGINT        NOT NULL,
    last_read_time TIMESTAMPTZ   NULL,
